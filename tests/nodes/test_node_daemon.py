...
# ---------------------------------------------------------------------------
# Handler timeout (T-163)
# ---------------------------------------------------------------------------

def test_handler_timeout_long_run_gets_2h_budget():
    ...
    assert nd._handler_timeout(cap) == 2 * 3600


def test_handler_timeout_non_long_run_keeps_configured():
    cap = {"name": "storage.list", "timeout": 120, "long_run": False}
    assert nd._handler_timeout(cap) == 120
